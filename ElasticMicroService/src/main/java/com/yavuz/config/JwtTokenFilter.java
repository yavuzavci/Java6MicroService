...
import com.yavuz.exception.ElasticServiceException;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        /**
         * Bu kısım filtreye takılan tüm isteklerin inceleneceği yerdir. Bu nedenle buraya gelen
         * tüm isteklerde Başlık(Header) kısmında Bearer token ı arıyoruz.
